...
<html lang="pt-br">
	<head>
        ...
        <meta itemprop="image" content="<?= $configBase ?>Images/General/default.png"/>
...
<body>
    ...
    <script src="<?= $configBase; ?>ajax/maskinput.js"></script>
    <script src="<?= $configBase; ?>ajax/jquery-money.js"></script>
    <script src="<?= $configBase; ?>ajax/jquery-form.js"></script>
    <script src="<?= $configBase; ?>ajax/views.js"></script>
