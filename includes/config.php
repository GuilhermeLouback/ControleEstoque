...
$_SESSION['user'] = 'Guilherme Louback';
...
$configBase = "http://localhost/"; //Url da Aplicação;
...
$nameAuthorSite = "Guilherme Louback e Julio Cesar Sacilloti Silva "; //Nome do Autor
$mainAuthorSite = "guilherme_lou@hotmail.com"; //E-mail do Autor
$phoneAuthorSite = "(32) 99835-9433"; //Telefone do Autor
...
define("DB_CLIENTS", "si_clientes");
define("DB_ORDERS", "si_pedidos");
define("DB_PRODUCTS", "si_produtos");
define("DB_PROVIDERS", "si_fornecedores");
