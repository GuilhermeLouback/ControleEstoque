<div class="profile bgcolor-blue noPrint">
	<div class="profile-img">
		<img src="<?= $configSite?><?=$themePathSite?>/images/users/autor.jpg" alt="Imagem do Usuário" title="Imagem do Usuário">
	</div>	
</div>

<div class="users bgcolor-blue noPrint">
	<p class="font-text-sub text-center color-white">Guilherme Louback</p>
</div>

<div class="navigator bgcolor-blue noPrint">
	<ul class="nav">
