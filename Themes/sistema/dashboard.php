...
<section class="content_right">
	...
	<article class="bgcolor-white">
		<img src="<?= $configBase ?><?= $themePathSite ?>/images/logo.png" alt="Logo da Empresa"
		...
		<div class="divisor3 cards bgcolor-blue">
			...
			<p class="color-white text-center font-weight-max title">
				<?= $Count ?>
			</p>
		</div>
		...
		$Read = $pdo->prepare("SELECT pedido_id, pedido_status, pedido_despachado FROM ".DB_ORDERS." WHERE pedido_status = :pedido_status AND pedido_despachado = :pedido_despachado");
		$Read->bindValue(':pedido_status', 1);
